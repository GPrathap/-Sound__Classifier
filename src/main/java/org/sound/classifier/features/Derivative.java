...
/**
 * Class implementing the most basic discrete derivative of a dependant mfcc.
...
public class Derivative extends MetaFeatureFactory {
	 ...
	 * 
	 * @param fe
	 *            base mfcc that this mfcc is to be bvased upon.
	 * @return fully constructed MetaFeatureFactory object ready for mfcc
	 *         extraction.
	 */
	 ...
	 * 
	 * @param samples
	 *            signal to be analyzed. Not used by this mfcc
	 * @param sampling_rate
	 *            sampling rate of the signal. Not used by this mfcc
	 * @param other_feature_values
	 *            provides most recent and next most recent values to be
	 *            compared
	 * @return discrete derivative of the underlying mfcc
	 */
	 ...
	 * <p>
	 * As a metafeature, recursively calls children for the mfcc requested.
	 * 
	 * @param index
	 ...
	 * <p>
	 * As a metafeature, recursively calls children to set the mfcc
	 * requested.
	 * 
	 * @param index
	 *            attribute to be set
...
public Object clone() {
	...
	/**
	 * Overridden to regenerate the mfcc definition. Perhaps its should be
	 ...
	 * 05-08-05 LPC is the only mfcc that requires this.
	 */
