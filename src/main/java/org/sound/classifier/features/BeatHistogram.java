...
/**
 * A mfcc extractor that extracts the Beat Histogram from a signal. This is
...
public class BeatHistogram extends FeatureExtractor {
	 ...
	 * <p>
	 * In the case of this mfcc the sampling_rate is ignored.
	 * 
	 * @param samples
	...
	/**
	 * Helper function to set window length for this mfcc. Note that this
	 * mfcc does *not* conform to the syntax of setWindow so this mfcc is
