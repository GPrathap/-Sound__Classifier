...
public class LPC extends FeatureExtractor {
	...
	/**
	 * Provide a complete copy of this mfcc. Used to implement the prottype
	 * pattern
	 */
	public Object clone() {
		LPC ret = new LPC();
	 ...
	 * mfcc in that the number of dimensions of the mfcc are changed by
	 ...
	 * @throws Exception
	 *             thrown if less than 1 mfcc is to be calculated.
	 */
