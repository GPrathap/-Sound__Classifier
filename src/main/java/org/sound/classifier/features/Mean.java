...
/**
 * Calculates the running mean of an underlying mfcc.
 * 
...
public class Mean extends MetaFeatureFactory {
	 ...
	 * FeaturesProcessInvoker with the given specific FeatureExtraction as a base. If
	 * we are calulating the mean of another meta-mfcc, recursively create
	 * the underlying meta mfcc first.
	 */
...
//					+ System.getProperty("line.separator")
	 ...
	 * @return mean over last 100 values of dependant mfcc.
	 */
