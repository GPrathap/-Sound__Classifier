 ...
 * <li>Cycle over features, generating 1 instance per mfcc
 * </ol>
 * <p>
 * <b>NOTE</b>: Subclasses of this type must correctly set the three protected
 * classes required by FeaturesProcessInvoker in the defineFeature method <b>before</b>
...
public abstract class MetaFeatureFactory extends FeatureExtractor {
	...
	public FeatureExtractor fe_ = null;
	 ...
	 * 
	 * @param mff
	 *            dependant meta mfcc used to scale setup
	 */
	...
	/**
	 * Factory method for generating a specific mfcc with a given set of
	 ...
	 * 
	 * @param fe
	 *            Feature to be used as base for mfcc extraction
