 ...
 * Contant Q MFCCs
 *
 * Implements MFCCs using the log constant q function.  Produces MFCCCal's without the error of
...
public class ConstantQMFCC extends FeatureExtractor
{
	 ...
	 */
	public Object clone(){
		return new jAudioFeatureExtractor.AudioFeatures.ConstantQ();
	}
    ...
    /**
	 * Borrowed from Orange Cow MFCCCal implementation (BSD)
